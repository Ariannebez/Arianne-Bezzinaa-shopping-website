...
<div class="col">
    ...
    <h1>Hearts Gold Ring</h1>
    </div>
    <div class="card-body">
    <h5 class="card-title">Gold plated</h5>
    <p class="card-text">

    <li>Inside diameter: 17.2mm</li> 
    <li>Width: 6mm</li>   
    <li>Opening: 4mm</li>
    ...
    <img src="https://kinclimg3.bluestone.com/f_jpg,c_scale,w_828,q_80,b_rgb:f0f0f0/giproduct/BIDG0319R180_YAA18DIG6XXXXXXXX_ABCD00-PICS-00001-1024-66194.png" class="card-img-top" alt="...">
    <div class="card-body">
    <p class="card-text">Gold rign</p>
    </div>
    </div>
