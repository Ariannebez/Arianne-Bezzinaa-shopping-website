...
<head>
    ...
    <title>HANDMADE CRYSTAL EARRINGS</title>
...
<div class="col mb-5">
    ...
    <h1>Handmade Crystal Earrings</h1>
    </div>
    <div class="card-body">
    <h5 class="card-title">Gold plated</h5>
    <p class="card-text">
    <li>Handmade & Brass Plated In 18Kt Gold</li> 
    <li>Czech Crystals</li>   
    <li> Nickel Free</li>
    ...
    <img src="https://www.exclusivecreations.com.mt/statementjewellery/wp-content/uploads/2021/02/IMG_1769.jpg" class="card-img-top" alt="...">
    <div class="card-body">
    <p class="card-text">Gold plated earrings</p>
    </div>
    </div>
